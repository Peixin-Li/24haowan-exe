...
class UserScore extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, game_id, score, game_time, create_time, update_time', 'required'),
			array('user_id, game_id, score, game_time', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, game_id, score, game_time, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
